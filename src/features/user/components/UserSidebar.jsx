      ...
      <div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[15px] text-gray-700">Tham gia {user?.createdAt ? new Date(user.createdAt).toLocaleDateString('vi-VN', { month: 'long', year: 'numeric' }) : 'March 2026'}</span>
          </div>
        </div>
      </div>
