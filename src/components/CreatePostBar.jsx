            ...
            {isExpanded && (
                <div className="mt-2 border-t border-gray-100 pt-2 pb-1">
                    <div className="relative mb-2 w-full max-w-sm" ref={dropdownRef}>
                        ...
                        {isTagDropdownOpen && filteredTopics.length > 0 && (
                            <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-xl shadow-lg max-h-72 overflow-y-auto no-scrollbar py-1">
